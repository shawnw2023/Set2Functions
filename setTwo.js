...
// CODE HERE 
function contains(arr, n, callback){
 if(arr.includes(n)){
  callback(true)
}else{
  callback(false)
...
// CODE HERE
uniq(names, uniqArr => {
  console.log("the new names array with all the duplicate names removed is " + uniqArr)
})
